	...
	<div class="content-container">
		<div class="div1" ref="setting1">
			<div>
				<span>Layout布局:</span>
				<button
					class="defaultcolor-btn"
					@click="btnHandler('layout')"
					value="red">
					默认
				</button>
				<input
					type="color"
					@input="inputHandler($event, 'layout')"
					:value="useColor.layoutColor" />
			</div>
			<div>
				<span>本地布局:</span>
				<button
					class="defaultcolor-btn"
					@click="btnHandler('setting1')"
					value="red">
					默认
				</button>
				<input
					type="color"
					@input="inputHandler($event, 'setting1')"
					:value="useColor.setting1Color" />
			</div>
		</div>
		<div class="div1" ref="setting2">
			<div>
				<span>Menu布局:</span>
				<button class="defaultcolor-btn" @click="btnHandler('menu')">
					默认
				</button>
				<input
					type="color"
					@input="inputHandler($event, 'menu')"
					:value="useColor.menuColor" />
			</div>
			<div>
				<span>本地布局:</span>
				<button
					class="defaultcolor-btn"
					@click="btnHandler('setting2')">
					默认
				</button>
				<input
					type="color"
					@input="inputHandler($event, 'setting2')"
					:value="useColor.setting2Color" />
			</div>
		</div>
		<div class="div1" ref="setting3">
			<div>
				...
				<button
					class="defaultcolor-btn"
					@click="btnHandler('pageHeader')">
					默认
				</button>
				<input
					type="color"
					@input="inputHandler($event, 'pageHeader')"
					:value="useColor.pageHeaderColor" />
			</div>
			<div>
				<span>本地布局:</span>
				<button
					class="defaultcolor-btn"
					@click="btnHandler('setting3')">
					默认
				</button>
				<input
					type="color"
					@input="inputHandler($event, 'setting3')"
					:value="useColor.setting3Color" />
			</div>
		</div>
		<div class="div1" ref="setting4">
			<div>
				...
				<button
					class="defaultcolor-btn"
					@click="btnHandler('setting4')">
					默认
				</button>
				<input
					type="color"
					@input="inputHandler($event, 'setting4')"
					:value="useColor.setting4Color" />
			</div>
		</div>
		<div class="div1" ref="setting5">
			<div>
				...
				<button
					class="defaultcolor-btn"
					@click="btnHandler('setting5')">
					默认
				</button>
				<input
					type="color"
					@input="inputHandler($event, 'setting5')"
					:value="useColor.setting5Color" />
			</div>
		</div>
		<div class="div1" ref="setting6">
			<div>
				...
				<button
					class="defaultcolor-btn"
					@click="btnHandler('setting6')">
					默认
				</button>
				<input
					type="color"
					@input="inputHandler($event, 'setting6')"
					:value="useColor.setting6Color" />
			</div>
		</div>
		<div class="div1" ref="setting7">
			<div>
				...
				<button
					class="defaultcolor-btn"
					@click="btnHandler('setting7')">
					默认
				</button>
				<input
					type="color"
					@input="inputHandler($event, 'setting7')"
					:value="useColor.setting7Color" />
			</div>
		</div>
		<div class="div1" ref="setting8">
			<div>
				...
				<button
					class="defaultcolor-btn"
					@click="btnHandler('setting8')">
					默认
				</button>
				<input
					type="color"
					@input="inputHandler($event, 'setting8')"
					:value="useColor.setting8Color" />
			</div>
		</div>
		<div class="div1" ref="setting9">
			<div>
				...
				<button
					class="defaultcolor-btn"
					@click="btnHandler('setting9')">
					默认
				</button>
				<input
					type="color"
					@input="inputHandler($event, 'setting9')"
					:value="useColor.setting9Color" />
			</div>
		</div>
	</div>
</template>
