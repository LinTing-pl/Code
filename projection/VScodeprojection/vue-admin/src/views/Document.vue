...
<template>
  <div class="content-container" @dragover="dragover">
    <div class="edit" ref="edit">
      <div class="top">
        ...
        <div class="down"  @dragenter="dragenter" @dragleave="dragleave" @drop="mouseup">
      <h2 ref="title">{{ data.title }}</h2>
      <div ref="content">
        {{ data.content }}
      </div>
      <span ref="info" class="info">拖放此处</span>
    </div>
    </div>    
    <div class="list">
      <div class="top">
      ...
      <div class="down">
      <div class="item" v-for="(item,index) in list" draggable="true" @dragstart="dragstart($event,item)" @dragend="dragend">
...
.is-active1{
  box-shadow: 0 0 20px rgb(66, 66, 221),0 0 40px rgb(66, 66, 221),inset 0 0 10px rgb(66, 66, 221) !important;
}
.active{
  border: 1px solid #000;
  box-shadow: 0 0 6px rgb(228, 235, 136);
