...
class Gui(object):
    def __init__(self):
        ...
        self.lb1 = tk.Label(self.spider, text='源语言:', height=1, font=('黑体'))  # 创建Lable文本
        self.lb2 = tk.Label(self.spider, text='翻译为:', height=1, font=('黑体'))  # 创建Lable文本

        self.text1 = tk.Text(self.spider, relief='groove')  # 用于接收输入的翻译内容
        self.text2 = tk.Text(self.spider, relief='groove', state='disabled')  # 用于显示翻译结果(禁止编辑)

        self.button1 = tk.Button(self.spider, text='→', font=('黑体', 20), bg='white', overrelief='groove',
